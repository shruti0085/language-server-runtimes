...
## [0.2.81](https://github.com/shruti0085/language-server-runtimes/compare/language-server-runtimes/v0.2.80...language-server-runtimes/v0.2.81) (2025-05-14)


### Features

* add agent interface for tool creation and usage ([c420d68](https://github.com/shruti0085/language-server-runtimes/commit/c420d68c563260ea933907ceeefac117f5462ac9))
...
* add cancellation token to agent spec ([#472](https://github.com/shruti0085/language-server-runtimes/issues/472)) ([1e65017](https://github.com/shruti0085/language-server-runtimes/commit/1e650179dc22692ffe2c5399a45731dc520506a4))
...
* add env variables getter in runtime ([#295](https://github.com/shruti0085/language-server-runtimes/issues/295)) ([93be997](https://github.com/shruti0085/language-server-runtimes/commit/93be9970f8c6aa23f609220e0c132e37fe567210))
...
* add initialization configuration options for file indexing ([#436](https://github.com/shruti0085/language-server-runtimes/issues/436)) ([155546f](https://github.com/shruti0085/language-server-runtimes/commit/155546fe092bad040817abd21816ec5051b897f3))
...
* add operational telemetry interface ([#312](https://github.com/shruti0085/language-server-runtimes/issues/312)) ([44ae86c](https://github.com/shruti0085/language-server-runtimes/commit/44ae86c1f33b2a71702cc55b2ad78c2ec22e380f))
* add opt-out mechanism to operational telemetry ([#330](https://github.com/shruti0085/language-server-runtimes/issues/330)) ([0de11b1](https://github.com/shruti0085/language-server-runtimes/commit/0de11b10b5556848633df351defe84350c7b5da1))
* add save option to initializeResult to allow LSP server to listen to save file events ([#309](https://github.com/shruti0085/language-server-runtimes/issues/309)) ([d80688f](https://github.com/shruti0085/language-server-runtimes/commit/d80688fe272cedd352a9e5ed8cd13279cad392a7))
* add workspaceIdentifier to AWSInitializationOptions ([#497](https://github.com/shruti0085/language-server-runtimes/issues/497)) ([256c549](https://github.com/shruti0085/language-server-runtimes/commit/256c549df6d446886457dd83ea4b71f31d3bf063))
...
* adding support for readFileSync method in workspace.fs ([#299](https://github.com/shruti0085/language-server-runtimes/issues/299)) ([3ef292a](https://github.com/shruti0085/language-server-runtimes/commit/3ef292a483d0f41e804511e1d951e09f5da36d46))
* allow write stream for tool invocations ([07e7c53](https://github.com/shruti0085/language-server-runtimes/commit/07e7c534d715836c99c08451e07805d8bf5cd668))
* change getConfigurationFromServer to fetch from all servers and aggregate ([#489](https://github.com/shruti0085/language-server-runtimes/issues/489)) ([5c13d69](https://github.com/shruti0085/language-server-runtimes/commit/5c13d6968683422468982ea1a1d7ac21d1649ae2))
* collect telemetry data from standalone runtime ([#392](https://github.com/shruti0085/language-server-runtimes/issues/392)) ([76d6869](https://github.com/shruti0085/language-server-runtimes/commit/76d68699fdb49147427b22574d7d1794c0bc31e6))
...
* delete cognito, update optel sdk, use otlp exporters ([#437](https://github.com/shruti0085/language-server-runtimes/issues/437)) ([446b1b8](https://github.com/shruti0085/language-server-runtimes/commit/446b1b8d47248ac4b64b7711e44b32c7c5e8cd10))
* empty line PR to release https://github.com/aws/language-server-runtimes/pull/379 ([#382](https://github.com/shruti0085/language-server-runtimes/issues/382)) ([2663a5e](https://github.com/shruti0085/language-server-runtimes/commit/2663a5e748e1b63e5b422968af562fd39f9a0da2))
* expose predicate to check symbolic link ([02002af](https://github.com/shruti0085/language-server-runtimes/commit/02002af823cce5feeefb00e243d8b48beab576e6))
...
* get telemetry aws config from env variables ([#345](https://github.com/shruti0085/language-server-runtimes/issues/345)) ([e2d7267](https://github.com/shruti0085/language-server-runtimes/commit/e2d7267aff2a5c3d3fe92131b9478319a9a91c6e))
* implement sdk runtime configurator to configure sdk clients at runtime ([#316](https://github.com/shruti0085/language-server-runtimes/issues/316)) ([ef82756](https://github.com/shruti0085/language-server-runtimes/commit/ef827565b32d1482b6e08d66b78774d7aed544eb))
* inject home directory into runtimes.  ([#424](https://github.com/shruti0085/language-server-runtimes/issues/424)) ([595475e](https://github.com/shruti0085/language-server-runtimes/commit/595475e448e9dc8fb74c4aec9c31eb7852db6e45))
...
* **runtimes:** add UpdateConfiguration protocol and server handlers ([df24447](https://github.com/shruti0085/language-server-runtimes/commit/df244475bf08caafd6fb4c905de8fbbce970af1d))
* **runtimes:** cache and expose initializeParams as a feature ([#378](https://github.com/shruti0085/language-server-runtimes/issues/378)) ([e3d4e17](https://github.com/shruti0085/language-server-runtimes/commit/e3d4e1772d29955ae71a6761f1be3251c443215e))
* **runtimes:** emit telemetry from SDK proxy configuration utility ([a82a708](https://github.com/shruti0085/language-server-runtimes/commit/a82a70810592909e1d82c74406124de847f1af0b))
* **runtimes:** extend awsClientCapabilities generically to signal server-specific capabilities ([9fd0f00](https://github.com/shruti0085/language-server-runtimes/commit/9fd0f00a784521c9ae4dac360d2eb8c81ab299fa))
* **runtimes:** extend lsp with didSaveTextDocument and lsp.worksapce with didCreateFiles, didDeleteFiles and didRenameFiles ([e8df283](https://github.com/shruti0085/language-server-runtimes/commit/e8df28359cdca9efdaf05dd963ef52d7fc45531b))
* **runtimes:** extend TestFeatures with API for simulating LSP init flow ([#483](https://github.com/shruti0085/language-server-runtimes/issues/483)) ([fa41c3d](https://github.com/shruti0085/language-server-runtimes/commit/fa41c3d662cdf5f9cd5c2312f7f11abbda50045f))
* **runtimes:** extended network proxy support ([7369086](https://github.com/shruti0085/language-server-runtimes/commit/7369086ad519843f0dfc74f7124e23f129f21e63))
* **runtimes:** extract reusable runtime logic into the `base-runtime.ts` ([ebcb52f](https://github.com/shruti0085/language-server-runtimes/commit/ebcb52f66dca8c85d3a842b21c8dbaccb19d6ad0))
* **runtimes:** log detail server info during initialization ([#285](https://github.com/shruti0085/language-server-runtimes/issues/285)) ([cd4ac14](https://github.com/shruti0085/language-server-runtimes/commit/cd4ac14381599c8599c70a6df85ac62cc9668832))
...
* support remove tool in Agent ([#501](https://github.com/shruti0085/language-server-runtimes/issues/501)) ([443415e](https://github.com/shruti0085/language-server-runtimes/commit/443415ee15349913eb2e8876cb56bb26c02a9e31))
* **types:** add mode to fs writeFile ([#423](https://github.com/shruti0085/language-server-runtimes/issues/423)) ([daae4e8](https://github.com/shruti0085/language-server-runtimes/commit/daae4e8e665bd334e6109921d9efcd5ab12c4ff8))
...
* **types:** types for device code support ([#353](https://github.com/shruti0085/language-server-runtimes/issues/353)) ([aa2fd53](https://github.com/shruti0085/language-server-runtimes/commit/aa2fd53ab14bbe412ede696e7eb86cd19a9b9b0b))
...
* add missing telemetry files ([#344](https://github.com/shruti0085/language-server-runtimes/issues/344)) ([e592796](https://github.com/shruti0085/language-server-runtimes/commit/e592796f901000e58fbdf93860a50ea697adaa89))
...
* adding try/catch to initialize lsp server, added telemetry log events  ([#320](https://github.com/shruti0085/language-server-runtimes/issues/320)) ([48b064b](https://github.com/shruti0085/language-server-runtimes/commit/48b064b5b690e5ce49efff2066f60b58b6f283d2))
* agent tools are shared between servers ([01a9f08](https://github.com/shruti0085/language-server-runtimes/commit/01a9f08f5c1f5920f519461fae8a7b8d92578233))
* avoid deprecated attribute path ([8efb2de](https://github.com/shruti0085/language-server-runtimes/commit/8efb2deff9aeb670f211920d892f0ba3c17bab0e))
* avoid path import ([5ee633a](https://github.com/shruti0085/language-server-runtimes/commit/5ee633aedcdb5244e9b7b2aa92534ebe07aee761))
* correct global context configuration param type ([#439](https://github.com/shruti0085/language-server-runtimes/issues/439)) ([95c40fc](https://github.com/shruti0085/language-server-runtimes/commit/95c40fca6212cc7d0f0e7c33d44fb0d8322f22f7))
* explicit check for initializationOptions and add optional chaining ([#310](https://github.com/shruti0085/language-server-runtimes/issues/310)) ([e97456d](https://github.com/shruti0085/language-server-runtimes/commit/e97456d6d5352042364f860483ea2721fc3268e1))
* export operational telemetry schemas ([#340](https://github.com/shruti0085/language-server-runtimes/issues/340)) ([5b4ca25](https://github.com/shruti0085/language-server-runtimes/commit/5b4ca25a03a3cfe5671bb01eae8e1d3c92c3b979))
* filter expired certificates in tets ([#506](https://github.com/shruti0085/language-server-runtimes/issues/506)) ([2dbb80f](https://github.com/shruti0085/language-server-runtimes/commit/2dbb80f15f9c770f104d1af9910bd71fa591b38b))
* fix the flaky test timeout error ([#359](https://github.com/shruti0085/language-server-runtimes/issues/359)) ([b907843](https://github.com/shruti0085/language-server-runtimes/commit/b9078435c918077215ff127ca8e84425bda9c4c0))
* handling of aws object of initializationOptions and initialize error handling ([#306](https://github.com/shruti0085/language-server-runtimes/issues/306)) ([f71547a](https://github.com/shruti0085/language-server-runtimes/commit/f71547a7a27adb62231e2c096560988a09ff6fea))
* moving the telemetry logging for initialization options to the l… ([#337](https://github.com/shruti0085/language-server-runtimes/issues/337)) ([3f0a826](https://github.com/shruti0085/language-server-runtimes/commit/3f0a8262ea8e809341ffce4f503517339267917b))
* put extended proxy behind feature flag ([#385](https://github.com/shruti0085/language-server-runtimes/issues/385)) ([41b01bd](https://github.com/shruti0085/language-server-runtimes/commit/41b01bd0131afc76c2dd52f5d3b763751352ca3e))
* revert the version of jose to 5.9.6 ([#441](https://github.com/shruti0085/language-server-runtimes/issues/441)) ([6ebc326](https://github.com/shruti0085/language-server-runtimes/commit/6ebc326eaf577159ba1bbaace37c24b6a0633226))
* route correct request type to button click ([#467](https://github.com/shruti0085/language-server-runtimes/issues/467)) ([d481123](https://github.com/shruti0085/language-server-runtimes/commit/d4811237789514df1420f0842819f9a4de83dc5f))
* **runtimes:** add doUpdateConfiguration to TestFeatures ([21d5d1d](https://github.com/shruti0085/language-server-runtimes/commit/21d5d1dc7c73499475b7c88c98d2ce760e5d26c8))
* **runtimes:** catch unhandled encryption validation and process exeptions ([e950103](https://github.com/shruti0085/language-server-runtimes/commit/e9501038192fbc6acfa144f48c33faeef61d69d8))
* **runtimes:** maintain nodejs built-in certificates for SDK proxy configuration ([#362](https://github.com/shruti0085/language-server-runtimes/issues/362)) ([83fa698](https://github.com/shruti0085/language-server-runtimes/commit/83fa698b3d0446f1b3cb6f1237866910a966026f))
* support JSON Schema extension keywords and properly infer required fields ([995a306](https://github.com/shruti0085/language-server-runtimes/commit/995a3066a445b7466a22faeba0b4f7d35d0fb9a0))
* throw error on initialize fail ([#307](https://github.com/shruti0085/language-server-runtimes/issues/307)) ([df148a2](https://github.com/shruti0085/language-server-runtimes/commit/df148a27bf4d84ec3466920848eff3e70bef493a))
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.27 to ^0.2.0
